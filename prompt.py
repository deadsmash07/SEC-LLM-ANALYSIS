...
def analyze(filing_text, api_url="https://api.anthropic.com/v1/complete"):
    ...
    {"Revenue": {"Compute & Networking": "$23.764 billion",
    "Graphics": "$8.218 billion"},
    "Net Income": {"Compute & Networking": "$7.634 billion",
    "Graphics": "$1.422 billion"},
    "Effective Tax Rate": "6.9%",
    "Deferred Tax Assets": "$5.02 billion",
    "Deferred Tax Liabilities": "$378 million",
    "Foreign Income Percentage": "56%"
    }
