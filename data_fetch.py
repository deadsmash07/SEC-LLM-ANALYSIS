...
def download_10k_data(company_name, email_address, ticker, start_year=None, end_year=None):
    ...
    try:
        ...
        num_filings = dl.get("10-K", ticker, after=start_date, before=end_date if end_year else None, include_amends=False, download_details=True)
...
if __name__ == "__main__":
    args = parse_args()
    download_10k_data(args.company, args.email, args.ticker, args.start_year, args.end_year)